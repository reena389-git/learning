...
CREATE OR REPLACE VIEW `d4001-centralus-tdvip-creditrisk`.`xvala_core`.`vw_pfe_asts_scenario` (
  ...
  `0_3_mo_Excess_Percentage`   COMMENT 'By how much the 0–3 month bucket exceeded its limit, as a percentage (source DOUBLE).',
  `3_12_mo_Excess_Percentage`  COMMENT 'By how much the 3–12 month bucket exceeded its limit, as a percentage.',
  `1_2_Yr_Excess_Percentage`   COMMENT 'By how much the 1–2 year bucket exceeded its limit, as a percentage.',
  `2_5_Yr_Excess_Percentage`   COMMENT 'By how much the 2–5 year bucket exceeded its limit, as a percentage.',
  `5_10_Yr_Excess_Percentage`  COMMENT 'By how much the 5–10 year bucket exceeded its limit, as a percentage.',
  `10_50_Yr_Excess_Percentage` COMMENT 'By how much the 10–50 year bucket exceeded its limit, as a percentage.',
  ...
  Exposure_Percentage COMMENT 'Row-level exposure percentage.',
  Exposure_Percentage_0_3_mo   COMMENT 'Exposure as a percentage of limit, 0–3 month bucket.',
  Exposure_Percentage_3_12_mo  COMMENT 'Exposure as a percentage of limit, 3–12 month bucket.',
  Exposure_Percentage_1_2_yr   COMMENT 'Exposure as a percentage of limit, 1–2 year bucket.',
  Exposure_Percentage_2_5_yr   COMMENT 'Exposure as a percentage of limit, 2–5 year bucket.',
  Exposure_Percentage_5_10_yr  COMMENT 'Exposure as a percentage of limit, 5–10 year bucket.',
  Exposure_Percentage_10_50_yr COMMENT 'Exposure as a percentage of limit, 10–50 year bucket.',
